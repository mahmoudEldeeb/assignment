...
public class ImageDescriptionActivity extends AppCompatActivity {
    ...
    private TextView textView,description_of_visit;
//    private GoogleMap googleMap
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        visitID=getIntent().getExtras().getInt("visitID",0);
        imageKey=getIntent().getExtras().getInt("imageKey",0);
        ...
        viewModelA.getVisitByID(visitID).observe(this, new Observer<Visit>() {
            ...
            public void onChanged(Visit visit) {
                ...
                description_of_visit.setText(visit.getDesscription());
